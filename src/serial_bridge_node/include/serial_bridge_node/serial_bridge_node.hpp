...
private:
  ...
  void on_map_result(const std_msgs::msg::String::ConstSharedPtr message);
  void process_placement(const vision_interfaces::msg::PuzzlePlacement & message);
  void preempt_for_task_command(int task_number);
  ...
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr map_result_subscription_;
